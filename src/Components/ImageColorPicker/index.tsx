        ...
        <article className="Image-Color-Picker__Wrap">
            <section className="Image-Color-Picker__Wrap__Box-Top">
                <div className="Image-Color-Picker__Wrap__Box-Top__Box-Left">
                    <canvas width={498} height={498} ref={canvasRef}></canvas>
                </div>
                <div className="Image-Color-Picker__Wrap__Box-Top__Box-Right">
                    <button className="Canvas-Button Button--Load" onClick={onBrowseImage}>Browse</button>
                    <button className="Canvas-Button Button--Reset" onClick={onResetImageAndCanvas}>Reset</button>
            ...
            <section className="Image-Color-Picker__Wrap__Box-Bottom">
                {
                    uniqueColors.map(color => (<div className="block" key={color} style={{backgroundColor: color}}></div>))
                }
            </section>
        </article>
    )
